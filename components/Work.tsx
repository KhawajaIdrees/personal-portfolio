      ...
      <div>
        {projects.map((project, i) => (
          <a
            key={i}
            href="#"
            className="group grid items-center gap-5 border-b border-border-light py-4 transition-smooth hover:bg-black/[.025] md:grid-cols-[.65fr_1.8fr_.15fr]"
          >
            {/* Meta */}
            <div className="text-[9px] font-bold tracking-wider opacity-60">
              {project.year}, {project.category}
            </div>

            {/* Project Name */}
            <div>
              <h3 className="display-face text-xl tracking-tight md:text-2xl">
                {project.name}
              </h3>
            </div>
            ...
            <div className="flex justify-start md:justify-end">
              <div className="flex h-8 w-8 items-center justify-center border border-text-primary transition-smooth group-hover:bg-text-primary group-hover:text-cream md:ml-auto">
